      ...
      <div className="bg-gray-200 h-full w-full">
              ...
              <div className="flex w-full sm:w-auto items-center sm:items-stretch justify-end sm:justify-start">
                <div className="flex items-center">
                  ...
                  <a href="/">
                    <img
                      className="h-6"
                      src="/img/icon/KC-Site-Logo-Horizontal-Menu.svg"
                    />
                  </a>
                </div>
              </div>
        ...
        <nav>
          ...
          <div
            className={
              show
                ? "w-full navMobile h-screen fixed  z-50 top-0 bottom-0 transform  translate-x-0 "
                : "   w-full navMobile h-screen absolute z-50 top-0 bottom-0 transform -translate-x-full"
            }
          >
            <div
              ...
              onClick={() => setShow(!show)}
            />
            <div className="w-64  fixed overflow-y-auto  top-0 bg-white shadow h-full flex-col justify-between navMobile pb-4 transition duration-150 ease-in-out">
                      ...
                      <div className="w-full flex items-center justify-between pt-1">
                        <div className="flex ">
                          ...
                          <p className=" text-gray-800 text-base leading-5 ml-2">
                            Now Pre-Leasing
                            <br />
                            Call <a href="tel:+12894983213">289.498.3213</a>
                          </p>
                        </div>
                      </div>
                    </div>
